        ...
        <div className="w-full bg-zinc-950 text-zinc-50 font-sans selection:bg-forest-500/30 selection:text-forest-100 antialiased -webkit-font-smoothing-antialiased">
            ...
            >
                <div className="flex items-center gap-3 md:gap-4 lg:gap-5">
                    ...
                    <span className="hidden md:inline-flex pointer-events-auto items-center gap-2 px-3 py-1 md:-mt-16 rounded-full border border-forest-500/50 bg-forest-900/40 text-forest-200 text-sm font-mono tracking-tight">
                ...
                <section className="md:hidden w-full bg-zinc-950 pt-20 pb-24 px-6 flex flex-col items-center gap-10">
                    ...
                    <div className="w-full h-[380px] max-w-md">
                        <Hero3D
                            ...
                            interactive
                            float
                            src="/models/pionio-3d-mobile.glb?v=3"
                        />
                    </div>
