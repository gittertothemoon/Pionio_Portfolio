...
export function PageHeader() {
    ...
    const label = locale === 'it' ? 'Pionio, torna alla home' : 'Pionio, back to the home page';
    return (
        <header
            ...
            role="banner"
        >
            <Link to={pagePath('home', locale)} title={label} aria-label={label} className="pointer-events-auto flex h-[34px] items-center">
