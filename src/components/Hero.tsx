            ...
            <div className="pointer-events-none flex-1 flex flex-col justify-center px-6 md:px-12 lg:px-24 pt-24 pb-36 md:pt-40 md:pb-20 lg:pt-48 z-10">
                ...
                >
                    <motion.div
                        ...
                        className="md:hidden inline-flex items-center gap-2 px-3 py-1 mb-8 rounded-full border border-forest-500/50 bg-forest-900/40 text-forest-200 text-sm font-mono tracking-tight"
                    >
